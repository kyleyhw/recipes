...
export const NUTRIENTS = [
  { key: "kcal", label: "Energy", unit: "kcal", decimals: 0, group: "energy", reference: 2000, required: true },
  { key: "protein", label: "Protein", unit: "g", decimals: 1, group: "macro", reference: 50, required: true },
  { key: "carbs", label: "Carbohydrate", unit: "g", decimals: 1, group: "macro", reference: 260, required: true },
  { key: "sugar", label: "of which sugars", unit: "g", decimals: 1, group: "macro", reference: 90, required: false, subordinate: true },
  { key: "fiber", label: "Fibre", unit: "g", decimals: 1, group: "macro", reference: 30, required: false },
  { key: "fat", label: "Fat", unit: "g", decimals: 1, group: "macro", reference: 70, required: true },
  { key: "satFat", label: "of which saturates", unit: "g", decimals: 1, group: "macro", reference: 20, required: false, subordinate: true },
  { key: "cholesterolMg", label: "Cholesterol", unit: "mg", decimals: 0, group: "macro", reference: null, required: false },
  { key: "sodiumMg", label: "Sodium", unit: "mg", decimals: 0, group: "mineral", reference: 2400, required: false },
  { key: "potassiumMg", label: "Potassium", unit: "mg", decimals: 0, group: "mineral", reference: 2000, required: false },
  { key: "calciumMg", label: "Calcium", unit: "mg", decimals: 0, group: "mineral", reference: 800, required: false },
  { key: "ironMg", label: "Iron", unit: "mg", decimals: 1, group: "mineral", reference: 14, required: false },
  { key: "magnesiumMg", label: "Magnesium", unit: "mg", decimals: 0, group: "mineral", reference: 375, required: false },
  { key: "zincMg", label: "Zinc", unit: "mg", decimals: 1, group: "mineral", reference: 10, required: false },
  { key: "vitaminAUg", label: "Vitamin A", unit: "µg", decimals: 0, group: "vitamin", reference: 800, required: false },
  { key: "vitaminCMg", label: "Vitamin C", unit: "mg", decimals: 1, group: "vitamin", reference: 80, required: false },
  { key: "vitaminDUg", label: "Vitamin D", unit: "µg", decimals: 1, group: "vitamin", reference: 5, required: false },
  { key: "vitaminEMg", label: "Vitamin E", unit: "mg", decimals: 1, group: "vitamin", reference: 12, required: false },
  { key: "vitaminB12Ug", label: "Vitamin B12", unit: "µg", decimals: 1, group: "vitamin", reference: 2.5, required: false },
  { key: "folateUg", label: "Folate", unit: "µg", decimals: 0, group: "vitamin", reference: 200, required: false },
