...
const en = {
  ...
  "diet.vegan": "Vegan",
  "diet.no-pork": "No pork",
  "diet.no-fish": "No fish",
  "diet.no-shellfish": "No shellfish",
  "diet.no-dairy": "No dairy",
  "diet.no-egg": "No egg",
  "diet.no-peanut": "No peanuts",
  "diet.no-nuts": "No tree nuts",
  "diet.no-sesame": "No sesame",
  "diet.no-soy": "No soy",
  ...
  keeping: "Storage",
  keepingUnused: "Leftover ingredients",
  fullPage: "Full page",
  close: "Close",
  ...
  "category.Rice & Noodles": "Rice & Noodles",
  "category.Meat & Fish": "Meat & Fish",
  "category.Tofu & Eggs": "Tofu & Eggs",
...
const zhHant: Dict = {
  ...
  "category.Rice & Noodles": "飯與麵",
  "category.Meat & Fish": "肉與魚",
  "category.Tofu & Eggs": "豆腐與蛋",
...
const zhHans: Dict = {
  ...
  "category.Rice & Noodles": "饭与面",
  "category.Meat & Fish": "肉与鱼",
  "category.Tofu & Eggs": "豆腐与蛋",
  "category.Vegetables": "蔬菜",
...
const ru: Dict = {
  ...
  "diet.vegan": "Веганское",
  "diet.no-pork": "Без свинины",
  "diet.no-fish": "Без рыбы",
  "diet.no-shellfish": "Без морепродуктов",
  "diet.no-dairy": "Без молочного",
  "diet.no-egg": "Без яиц",
  "diet.no-peanut": "Без арахиса",
  "diet.no-nuts": "Без орехов",
  "diet.no-sesame": "Без кунжута",
  "diet.no-soy": "Без сои",
  ...
  keeping: "Хранение",
  keepingUnused: "Остатки продуктов",
  ...
  "category.Rice & Noodles": "Рис и лапша",
  "category.Meat & Fish": "Мясо и рыба",
  "category.Tofu & Eggs": "Тофу и яйца",
