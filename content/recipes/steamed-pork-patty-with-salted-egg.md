...
3. Add the pork and the ginger. Stir hard with chopsticks in one direction only — never back and forth — for 60 to 90 seconds. It starts sloppy and is done the moment it lifts out on the chopsticks in one mass. Both sides of that moment are a mistake: stop before it and the water weeps straight back out in the steamer, carry on well past it and you build the springy gel a sausage is made of, which steams rubbery.
...
beating the water in. Stop when it clings rather than working to a clock: this
recipe is the wetter of the two patties here and therefore the more forgiving,
but the same over-stirring that turns the bean curd one rubbery will do it to
this one as well.
...
here, since these two egg whites bring their own.
...
- 2026-08-17: Cut the stir from a flat 3 minutes to 60 to 90 seconds, after the bean curd patty came out rubbery from the same instruction. This one has three times the liquid and is the more forgiving of the two, but the instruction was wrong in both: the criterion is that it clings to the spoon, not that a clock has run.
